...
(async () => {
    ...
    try{
    await page.goto('https://8081-eeddabbdcfaaebeafaceeaaebbbceffdb.examlyiopb.examly.io/');
...
(async () => {
  ...
  await page.setViewport({
    ...
    await page.click('#loginButton');
    await page.waitForNavigation();
    await page.waitForSelector('#adminAddGround',{timeout:3000});
    await page.click('#adminAddGround');
    await page.waitForSelector('#addButton',{timeout:3000});
    console.log('TESTCASE:FE_AdminAddGroundOperation:success');
  }
   catch(e){
    console.log('TESTCASE:FE_AdminAddGroundOperation:failure');
  }finally{
    await page.close();
    await browser.close();
  }
...
(async () => {
  ...
  await page.setViewport({
    ...
    await page.waitForNavigation();
    await page.waitForSelector('#adminAddGround',{timeout:3000});
    await page.click('#adminGroundProfile');
